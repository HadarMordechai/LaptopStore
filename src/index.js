...
const { createRedisClient, insertToTable, shutdownRedisClient } = require("./redisConnector");
const { registerNewUser } = require("./users/users-service"); 
const { registerNewActivity, findUserCheckout, findAllActivities } = require("./activities/activities-service");
const { findAllLaptops, registerNewLaptop } = require("./laptops/laptops-service");
const { registerNewContact, findAllContacts, updateContactActive } = require("./contact/contact-service");
...
// *****IMPORTANT!!!***** unmark if it's your first time running the project
// for(i in laptops) {
